...
public class MongoPerformanceMonitor : IMongoPerformanceMonitor
{
    ...
    public Task<PerformanceMetrics> GetMetricsAsync(TimeSpan? period = null)
    {
        ...
        lock (_lockObject)
        {
            ...
            var metrics = new PerformanceMetrics
            {
                ...
                AverageResponseTime = TimeSpan.FromMilliseconds(validMetrics.Average(m => m.Duration.TotalMilliseconds)),
    ...
    private class OperationTimer : IDisposable
    {
        ...
        public OperationTimer(string operationName, string collectionName, MongoPerformanceMonitor monitor, ILogger logger)
        {
