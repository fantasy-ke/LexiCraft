...
public interface IDistributedCacheService
{
    ...
    /// <param name="options">缓存配置选项</param>
    /// <param name="expiry">过期时间，为空时使用 options.Expiry</param>
    Task HashSetAsync(string key, Dictionary<string, string> values, CacheServiceOptions options,
    ...
    /// <param name="expiry">过期时间</param>
    /// <returns>是否设置成功</returns>
    Task<bool> HashSetAsync(string key, string field, string value, CacheServiceOptions options,
        TimeSpan? expiry = null);
    ...
    /// <param name="expiry">过期时间</param>
    /// <param name="options">缓存配置选项</param>
    Task HashIncrementManyAsync(string hashId, IEnumerable<KeyValuePair<string, long>> keyValuePairs, TimeSpan? expiry,
