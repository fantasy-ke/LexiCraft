...
namespace Z.OSSCore
{
    public static class OssServiceExtensions
    {
        ...
        extension(IServiceCollection services)
        {
            ...
            private IServiceCollection AddOssService(string key = "SSOConfig", Action<OSSOptions> oSSOptions = null)
            {
            ...
            /// <returns>服务集合</returns>
            public IServiceCollection AddOSSService(Action<OSSOptions> option)
            {
