...
public class UserSetting : SimpleAuditEntity<Guid>
{
    ...
    private UserSetting() { } // For EF Core
    ...
    public void UpdateNotificationSettings(bool receiveNotifications, bool receiveEmailUpdates, bool receivePushNotifications)
    {
