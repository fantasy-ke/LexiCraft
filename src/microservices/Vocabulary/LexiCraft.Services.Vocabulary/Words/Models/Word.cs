...
public class Word : AuditEntity<long>
{
    ...
    private Word(string spelling, string? phonetic, string? pronunciationUrl, string? definitions, string? examples,
        List<string>? tags)
    {
    ...
    public static Word Create(string spelling, string? phonetic, string? pronunciationUrl, string? definitions,
        string? examples, List<string>? tags)
    {
