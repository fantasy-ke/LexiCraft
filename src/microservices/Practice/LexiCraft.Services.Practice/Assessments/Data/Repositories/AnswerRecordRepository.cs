        ...
        IAnswerRecordRepository
{
    ...
    public async Task<AnswerRecord?> GetUserAnswerAsync(Guid practiceTaskItemId, string userId, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<List<AnswerRecord>> GetAnswersByStatusAsync(AnswerStatus status, CancellationToken cancellationToken = default)
    {
        return await FindAsync(x => x.Status == status, cancellationToken);
    }

    public async Task<List<AnswerRecord>> GetAnswersInDateRangeAsync(DateTime startDate, DateTime endDate, CancellationToken cancellationToken = default)
    {
