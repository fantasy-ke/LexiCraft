...
namespace LexiCraft.AuthServer.Infrastructure.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20251214033541_add-permission")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LexiCraft.AuthServer.Domain.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5a3da85a-4146-48ca-83ec-9f1089634a20"),
                            Avatar = "🦜",
                            CreateAt = new DateTime(2025, 12, 14, 11, 35, 41, 121, DateTimeKind.Local).AddTicks(7946),
                            Email = "one@fatnasyke.fun",
                            IsDeleted = false,
                            LastLoginAt = new DateTime(2025, 12, 14, 3, 35, 41, 121, DateTimeKind.Utc).AddTicks(7429),
                            PasswordHash = "063A161B97F1E2E9D48555B9E9F678F0",
                            PasswordSalt = "vK25in+n3kC2wZkq+1zBFQ==",
            ...
            modelBuilder.Entity("LexiCraft.AuthServer.Domain.Users.UserPermission", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
