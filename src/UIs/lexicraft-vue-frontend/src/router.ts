...
import {CALLBACK_PATH, LOGIN_PATH, REDIRECT_PATH, REGISTER_PATH} from '@/config/auth.config'
...
export const routes: RouteRecordRaw[] = [
    ...
    // 现代化应用路由 - 需要登录
    {
        ...
        children: [
            ...
            {
                path: 'practice-articles/:id',
                redirect: to => `/practice-loading/${to.params.id}?target=/practice/articles`
            },
